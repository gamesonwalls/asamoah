        ...
        <div className="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
          <div className="mb-1 w-full">
            <div className="mb-4">
              ...
              <h1 className="flex justify-between  mt-2 text-xl sm:text-2xl font-semibold text-gray-900">
                <div>
                  ...
                  <button
                    ...
                    style={{ height: 24, marginTop: -2 }}
                  >
                    Base Info <InformationCircleIcon width={20} />
                    <span class="flex h-4 w-4  justify-end">
                      <span className="animate-ping h-full w-full rounded-full bg-gray-400 opacity-75"></span>
                    </span>
                  </button>
                </div>
                ...
                <div>
                  <button
                    type="button"
                    className=" col-span-full text-black bg-white border-b hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium inline-flex items-center justify-center rounded-lg text-sm px-3 py-2 text-center sm:w-auto"
                  >
                    <ShoppingCartIcon width={20} /> Cart{" "}
                    <span className="mr-2 ml-2"> 0</span>
                  </button>
                </div>
              </h1>
            </div>
                    ...
                    <tr className="hover:bg-gray-100">
                      ...
                      <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">
                        ...
                        <div class="text-base font-semibold text-gray-900">
                          VISA DEBIT, PREPAID, VANDLE CARD
                        </div>
